...
# 1. The Critical Fix: Set the MUSB Choice Block exclusively to DUAL_ROLE
...
sudo mount --bind /dev/pts /media/yo/ROOTFS/dev/pts # optional, untested
...
sudo umount /media/$USER/ROOTFS/dev/pts # optional, untested
